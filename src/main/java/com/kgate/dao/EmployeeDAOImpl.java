...
public class EmployeeDAOImpl implements EmployeeDAO {
    ...
    public List<Employee> searchEmployeesBySkill(String txt) {
        ...
        String qry = "select employee0_.name, employee0_.email, employee0_.address, employee0_.telephone, employee0_.category  from  employee123 employee0_ cross  join join_employee_skill listskill1_, Skills skill2_  where  employee0_.id=listskill1_.id and listskill1_.skill_Id=skill2_.skill_Id  and skill2_.skill_name LIKE '" + txt + "'";
...
//          }
    ...
    public List<Employee> displayByManagerId(String email) {
        ...
        String query = "select  name,address,telephone,email,status,managerId,password,category from employee123 where managerId=(select id from employee123 where email='" + email + "') ";
