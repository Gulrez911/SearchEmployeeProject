...
public class TaskDaoImpl implements TaskDao {
	...
	public String getManagerEmail(String email) {
		String query = "select distinct(e.email) from task_details td cross join employee123 e where td.managerId = e.id and td.Emp_Email='"
				+ email + "'";
	...
	public String getEmployeeName(String name) {
		String query = "select distinct(employee123.name) from employee123 cross join task_details where employee123.email='"
				+ name + "'";
	...
	public String getManagerName(String name) {
		String query = "select distinct(employee123.name) from employee123 cross join task_details where task_details.managerId=employee123.id and task_details.Emp_Email='"
				+ name + "'";
